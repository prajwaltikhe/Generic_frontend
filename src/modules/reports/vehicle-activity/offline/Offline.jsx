...
const columns = [
  {
    key: 'created_at',
    header: 'Date & Time',
    render: (_, r) => (r?.created_at ? moment(r.created_at).format('YYYY-MM-DD HH:mm:ss') : '-'),
  },
  ...
  },
  {
    ...
    render: (_, r) => r?.driver_contact_number || '-',
  },
...
function Offline() {
  ...
  const handleExport = () => exportToExcel({ ...exportConf, fileName: 'offline_report.xlsx' });
  const handleExportPDF = () =>
    exportToPDF({ ...exportConf, fileName: 'offline_report.pdf', orientation: 'landscape' });

...
function Parked() {
  ...
  const handleExport = () => exportToExcel({ ...exportConf, fileName: 'parked_report.xlsx' });
  const handleExportPDF = () => exportToPDF({ ...exportConf, fileName: 'parked_report.pdf', orientation: 'landscape' });
